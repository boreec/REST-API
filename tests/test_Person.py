...
class TestPerson(unittest.TestCase):
    ...
    def test_verify_firstName_raises_exception(self):
        ...
        self.assertRaises(
            Exception, Person("", "!nv@lidN@m3", "", "", "").verify_firstName
        )
    ...
    def test_verify_firstName_good_format(self):
        ...
        try:
            ...
            self.fail(
                "Person.verify_firstName() raised Exception for good name format."
            )
    ...
    def test_verify_lastName_raises_exception(self):
        ...
        self.assertRaises(
            Exception, Person("", "", "!nv@lidN@m3", "", "").verify_lastName
        )
    ...
    def test_verify_email_raises_exception(self):
        ...
        self.assertRaises(
            Exception, Person("", "", "", "test@test@.com", "").verify_email
        )
        self.assertRaises(
            Exception, Person("", "", "", "@:@:gmail.com", "").verify_email
        )
    ...
    def test_verify_birthday_raises_exception(self):
        ...
        self.assertRaises(
            Exception, Person("", "", "", "", "March 21st 1998").verify_birthday
        )
        self.assertRaises(
            Exception, Person("", "", "", "", "3000-01-01").verify_birthday
        )
        self.assertRaises(
            Exception, Person("", "", "", "", "1800-01-01").verify_birthday
        )
        self.assertRaises(
            Exception, Person("", "", "", "", "1998-13-01").verify_birthday
        )
        self.assertRaises(
            Exception, Person("", "", "", "", "1998-02-29").verify_birthday
        )
    ...
    def test_verify_birthday_good_format(self):
        ...
        try:
            ...
            self.fail(
                "Person.verify_birthday() raised exception for good birthday format."
            )
