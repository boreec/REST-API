...
class TestRoutesPUT(unittest.TestCase):
    ...
    def test_update_person_success(self):
        ...
        self.assertEqual(
            self.person_data["firstName"], json.loads(response.data)["firstName"]
        )
        self.assertEqual(
            self.person_data["lastName"], json.loads(response.data)["lastName"]
        )
        self.assertEqual(
            self.person_data["birthday"], json.loads(response.data)["birthday"]
        )
