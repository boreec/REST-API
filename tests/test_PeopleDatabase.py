...
class TestPeopleDatabase(unittest.TestCase):
    ...
    def test_select_person_by_id_for_unknown_id(self):
        ...
        """
        self.assertEqual(
            None, self.db.select_person_by_id("41f7ad9c-0e21-43c9-bd8e-2678fe421232")
        )
    ...
    def test_select_persons_by_name_starting_with_j(self):
        ...
        self.assertTrue(
            persons[0]["firstName"] == "John" or persons[0]["firstName"] == "Jane"
        )
        self.assertTrue(
            persons[1]["firstName"] == "John" or persons[1]["firstName"] == "Jane"
        )
